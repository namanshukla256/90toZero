...
const BuyoutCalculatorPage = () => {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Calculate Your Buyout</h1>
                <p className="text-gray-600">Estimate your notice period buyout amount and loan EMIs</p>
            </div>
